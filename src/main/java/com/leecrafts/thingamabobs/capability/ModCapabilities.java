...
import com.leecrafts.thingamabobs.capability.entity.IEntityExplosivePastryCap;
...
public class ModCapabilities {
    ...
    public static final Capability<IEntityExplosivePastryCap> ENTITY_EXPLOSIVE_PASTRY_CAPABILITY = CapabilityManager.get(new CapabilityToken<>(){});
